    ...
    return (
        <CustomFooter id="contact">
            <div>
                ...
                <p>
                    Spares created in 2023 is a Project Management tool focusing
                    on Final Year Projects that are anually created as an
                    evaluation method on academic grounds.
                </p>
            </div>
            <div>
                <p>
