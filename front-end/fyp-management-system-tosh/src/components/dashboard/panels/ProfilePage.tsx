        ...
        <h1>Profile</h1>
            { userData[0] !==undefined?
                ...
                <Grid container spacing={4}>
                    <Grid item xs={12} md={6}>
                        <Card sx={{ padding: '10px 35px', borderRadius: '20px' }}>
                            ...
                            >
                                ...
                                <Grid item xs={6}>
                                    <p>
                                        {userData[0].yellowtasks + userData[0].redtasks}
                                    </p>
                                </Grid>
                                <Grid item xs={6}></Grid>
                            </Grid>
                    ...
                    { Object.keys(detailsData).length > 0 && userData[0].isstudent ?
                    (<Grid item xs={12} md={6}>
                        {/*? Current Project Card */}
                        <Grid container spacing={4}>
                            <Grid item xs={12}>
                                <Card sx={{ borderRadius: '20px' }}>
                                    <CardActionArea href={`../project/${detailsData[0].projectid}`} sx={{ padding: '10px 15px' }}>
                                        <p>Current Project</p>
