...
const SparesLogoFull: React.FC<SparesLogoFullProps> = ({ fill2 = ' #9f71b1', fill = '#6ac8e5', width = 100, height = 100, ...props }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 612 120.27`} {...props}>
            <defs>
                <style>
                    {`
                    .cls-1 {
            ...
            <g className="cls-1">
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        ...
                        <circle className="cls-4" cx="19.27" cy="23.49" r="19.26" />
                        <circle className="cls-5" cx="66.93" cy="96.78" r="19.26" />
                        <path className="cls-2"
