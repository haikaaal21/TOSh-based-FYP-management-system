            ...
            <div>
                <section className="" id="home">
                    <div className="text-4xl text-justify md:text-6xl font-bold">
                        ...
                        <p className="font-normal leading-5">
                            Control, Monitor, and Guide your students using
                            SPARES to achieve the optimal output.
                        </p>
                    </div>
                    <div>
                        <p>AsestImage</p>
                ...
                <section id="about" className="secondSect">
                    <h2 className="font-bold text-3xl md:text-4xl">
                        Guide your students to the new era of project management
                        and produce more quality outputs
                    </h2>
                    <span>MainAssetImageHere</span>
                </section>
                <section id="hall-of-shame">
                    <h2 className="font-bold text-3xl md:text-4xl m-4">
                        Hall of Shame
                    </h2>
                    <span>TableHere</span>
